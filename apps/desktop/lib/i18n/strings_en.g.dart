...
class Translations with BaseTranslations<AppLocale, Translations> {
	...
	late final TranslationsPageDesktopPopupEn page_desktop_popup = TranslationsPageDesktopPopupEn.internal(_root);
...
extension on Translations {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'page_desktop_popup.newversion_banner_text_found_new_version' => 'New version found: {}',
			'page_desktop_popup.newversion_banner_btn_update' => 'Update',
			'page_desktop_popup.limited_banner_title' => 'Functionality is limited, please follow the tips to check.',
			'page_desktop_popup.limited_banner_text_screen_capture' => 'Grant screen recording access',
			'page_desktop_popup.limited_banner_text_screen_selection' => 'Grant accessibility access',
			...
			'page_desktop_popup.limited_banner_msg_allow_access_tip' => 'If there is no response after clicking "Allow", please click "Go Settings" to set it manually.',
			'page_desktop_popup.limited_banner_msg_all_access_allowed' => 'The Screen extract text is enabled',
			'page_desktop_popup.limited_banner_msg_all_access_not_allowed' => 'The required access are not allowed.\nPlease check and set again.',
			'page_desktop_popup.input_hint' => 'Enter the word or text here',
			'page_desktop_popup.text_extracting_text' => 'Extracting text...',
			'page_desktop_popup.tip_translation_mode' => 'Current translation mode: {}',
			'page_desktop_popup.tip_extract_text_from_screen_capture' => 'Capture screen area and recognize text',
			'page_desktop_popup.tip_extract_text_from_clipboard' => 'Read clipboard content',
			'page_desktop_popup.btn_clear' => 'Clear',
			'page_desktop_popup.btn_trans' => 'Translate',
			'page_desktop_popup.msg_please_enter_word_or_text' => 'No text entered or text not extracted',
			'page_desktop_popup.msg_capture_screen_area_canceled' => 'Capture screen area has been canceled',
