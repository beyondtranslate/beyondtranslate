...
class Translations with BaseTranslations<AppLocale, Translations> {
	...
	late final TranslationsEngineScopeEn engine_scope = TranslationsEngineScopeEn.internal(_root);
	late final TranslationsOcrEngineEn ocr_engine = TranslationsOcrEngineEn.internal(_root);
	late final TranslationsTranslationModeEn translation_mode = TranslationsTranslationModeEn.internal(_root);
	late final TranslationsThemeModeEn theme_mode = TranslationsThemeModeEn.internal(_root);
	late final TranslationsWordPronunciationEn word_pronunciation = TranslationsWordPronunciationEn.internal(_root);
	late final TranslationsTrayContextMenuEn tray_context_menu = TranslationsTrayContextMenuEn.internal(_root);
	late final TranslationsMiniTranslatorEn mini_translator = TranslationsMiniTranslatorEn.internal(_root);
	late final TranslationsPageLanguageChooserEn page_language_chooser = TranslationsPageLanguageChooserEn.internal(_root);
	late final TranslationsPageOcrEngineChooserEn page_ocr_engine_chooser = TranslationsPageOcrEngineChooserEn.internal(_root);
	late final TranslationsPageOcrEngineCreateOrEditEn page_ocr_engine_create_or_edit = TranslationsPageOcrEngineCreateOrEditEn.internal(_root);
	late final TranslationsPageOcrEngineTypeChooserEn page_ocr_engine_type_chooser = TranslationsPageOcrEngineTypeChooserEn.internal(_root);
	late final TranslationsPageOcrEnginesManageEn page_ocr_engines_manage = TranslationsPageOcrEnginesManageEn.internal(_root);
	late final TranslationsPageSettingAppLanguageEn page_setting_app_language = TranslationsPageSettingAppLanguageEn.internal(_root);
	late final TranslationsPageSettingExtractTextEn page_setting_extract_text = TranslationsPageSettingExtractTextEn.internal(_root);
	late final TranslationsPageSettingInterfaceEn page_setting_interface = TranslationsPageSettingInterfaceEn.internal(_root);
	late final TranslationsPageSettingShortcutsEn page_setting_shortcuts = TranslationsPageSettingShortcutsEn.internal(_root);
	late final TranslationsPageSettingThemeModeEn page_setting_theme_mode = TranslationsPageSettingThemeModeEn.internal(_root);
	late final TranslationsPageSettingTranslateEn page_setting_translate = TranslationsPageSettingTranslateEn.internal(_root);
	late final TranslationsPageSettingsEn page_settings = TranslationsPageSettingsEn.internal(_root);
	late final TranslationsPageRuntimeDebugEn page_runtime_debug = TranslationsPageRuntimeDebugEn.internal(_root);
	late final TranslationsPageTranslationEngineChooserEn page_translation_engine_chooser = TranslationsPageTranslationEngineChooserEn.internal(_root);
	late final TranslationsPageTranslationEngineCreateOrEditEn page_translation_engine_create_or_edit = TranslationsPageTranslationEngineCreateOrEditEn.internal(_root);
	late final TranslationsPageTranslationEngineTypeChooserEn page_translation_engine_type_chooser = TranslationsPageTranslationEngineTypeChooserEn.internal(_root);
	late final TranslationsPageTranslationEnginesManageEn page_translation_engines_manage = TranslationsPageTranslationEnginesManageEn.internal(_root);
	late final TranslationsPageTranslationTargetNewEn page_translation_target_new = TranslationsPageTranslationTargetNewEn.internal(_root);
	late final TranslationsPageYourPlanSelectorEn page_your_plan_selector = TranslationsPageYourPlanSelectorEn.internal(_root);
	late final TranslationsWidgetRecordShortcutDialogEn widget_record_shortcut_dialog = TranslationsWidgetRecordShortcutDialogEn.internal(_root);
}
...
class TranslationsMiniTranslatorEn {
	...
	String get newversion_banner_text_found_new_version => 'New version found: {}';

	/// en: 'Update'
	String get newversion_banner_btn_update => 'Update';

	/// en: 'Functionality is limited, please follow the tips to check.'
	String get limited_banner_title => 'Functionality is limited, please follow the tips to check.';
...
class TranslationsPageOcrEnginesManageEn {
	...
	String get pref_section_description_private => 'Long press an item to reorder it';
}
...
class TranslationsPageSettingExtractTextEn {
	...
	String get pref_section_title_default_detect_text_engine => 'Default detect text engine';
...
class TranslationsPageSettingInterfaceEn {
	...
	String get pref_section_title_max_window_height => 'Maximum window height (logical pixels)';
...
class TranslationsPageSettingShortcutsEn {
	...
	String get pref_section_title_extract_text => 'Screen / Clipboard extract text';

	/// en: 'Input assist function'
	String get pref_section_title_input_assist_function => 'Input assist function';
	...
	String get pref_item_title_translate_input_content => 'Translate input content';
}
...
class TranslationsPageSettingTranslateEn {
	...
	String get pref_section_title_default_translate_engine => 'Default translate engine';

	/// en: 'Translation mode'
	String get pref_section_title_translation_mode => 'Translation mode';

	/// en: 'Default detect language engine'
	String get pref_section_title_default_detect_language_engine => 'Default detect language engine';
	...
	String get pref_item_title_double_click_copy_result => 'Double-click to copy translation result';
}
...
class TranslationsPageSettingsEn {
	...
	String get pref_item_title_submit_with_meta_enter => 'Submit with Ctrl + Enter';

	/// en: 'Submit with ⌘ + Enter'
	String get pref_item_title_submit_with_meta_enter_mac => 'Submit with ⌘ + Enter';
	...
	late final TranslationsPageSettingsExitAppDialogEn exit_app_dialog = TranslationsPageSettingsExitAppDialogEn.internal(_root);
}
...
class TranslationsPageRuntimeDebugEn {
	...
	String get description => 'Validate flutter_rust_bridge by calling the Rust runtime directly from desktop.';
	...
	String get mac_only_note => 'This validation page is planned for macOS first. Other desktop platforms may compile but are not part of this verification scope.';

	/// en: 'Provider'
	String get provider_section_title => 'Provider';

	/// en: 'Provider config YAML'
	String get provider_config_label => 'Provider config YAML';
	...
	String get result_idle_description => 'Submit a request to inspect the Rust runtime response here.';
	...
	/// en: 'Provider config YAML is required'
	String get validation_provider_config_required => 'Provider config YAML is required';

	/// en: 'Source language is required'
	String get validation_source_language_required => 'Source language is required';

	/// en: 'Target language is required'
	String get validation_target_language_required => 'Target language is required';
...
class TranslationsPageYourPlanSelectorEn {
	...
	String get pref_section_title_your_plan_expiry_date => 'Your plan expiry date';
...
extension on Translations {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'mini_translator.newversion_banner_text_found_new_version' => 'New version found: {}',
			'mini_translator.newversion_banner_btn_update' => 'Update',
			'mini_translator.limited_banner_title' => 'Functionality is limited, please follow the tips to check.',
			'mini_translator.limited_banner_text_screen_capture' => 'Grant screen recording access',
			'mini_translator.limited_banner_text_screen_selection' => 'Grant accessibility access',
			...
			'mini_translator.limited_banner_msg_allow_access_tip' => 'If there is no response after clicking "Allow", please click "Go Settings" to set it manually.',
			'mini_translator.limited_banner_msg_all_access_allowed' => 'The Screen extract text is enabled',
			'mini_translator.limited_banner_msg_all_access_not_allowed' => 'The required access are not allowed.\nPlease check and set again.',
			...
			'mini_translator.tip_extract_text_from_screen_capture' => 'Capture screen area and recognize text',
			'mini_translator.tip_extract_text_from_clipboard' => 'Read clipboard content',
			'mini_translator.btn_clear' => 'Clear',
			'mini_translator.btn_trans' => 'Translate',
			'mini_translator.msg_please_enter_word_or_text' => 'No text entered or text not extracted',
			'mini_translator.msg_capture_screen_area_canceled' => 'Capture screen area has been canceled',
			...
			'page_ocr_engine_chooser.pref_item_title_no_available_engines' => 'No available engines',
			'page_ocr_engine_create_or_edit.title' => 'Add Text Detection Engine',
			'page_ocr_engine_create_or_edit.pref_section_title_engine_type' => 'Engine type',
			...
			'page_ocr_engines_manage.pref_section_description_private' => 'Long press an item to reorder it',
			'page_setting_app_language.title' => 'Display Language',
			'page_setting_extract_text.title' => 'Screen extract text',
			'page_setting_extract_text.pref_section_title_default_detect_text_engine' => 'Default detect text engine',
			'page_setting_extract_text.pref_item_auto_copy_detected_text' => 'Auto copy the detected text',
			'page_setting_interface.title' => 'Interface',
			'page_setting_interface.pref_section_title_tray_icon' => 'Tray Icon',
			'page_setting_interface.pref_section_title_tray_icon_style' => 'Tray Icon Style',
			'page_setting_interface.pref_section_title_max_window_height' => 'Maximum window height (logical pixels)',
			'page_setting_interface.pref_item_title_show_tray_icon' => 'Show Tray Icon',
			'page_setting_shortcuts.title' => 'Shortcuts',
			'page_setting_shortcuts.pref_section_title_extract_text' => 'Screen / Clipboard extract text',
			'page_setting_shortcuts.pref_section_title_input_assist_function' => 'Input assist function',
			'page_setting_shortcuts.pref_item_title_show_or_hide' => 'Show/Hide',
			'page_setting_shortcuts.pref_item_title_hide' => 'Hide',
			'page_setting_shortcuts.pref_item_title_extract_text_from_selection' => 'Selection',
			'page_setting_shortcuts.pref_item_title_extract_text_from_capture' => 'Capture Area',
			'page_setting_shortcuts.pref_item_title_extract_text_from_clipboard' => 'Clipboard',
			'page_setting_shortcuts.pref_item_title_translate_input_content' => 'Translate input content',
			'page_setting_theme_mode.title' => 'Theme Mode',
			'page_setting_translate.title' => 'Translate',
			'page_setting_translate.pref_section_title_default_translate_engine' => 'Default translate engine',
			'page_setting_translate.pref_section_title_translation_mode' => 'Translation mode',
			'page_setting_translate.pref_section_title_default_detect_language_engine' => 'Default detect language engine',
			'page_setting_translate.pref_section_title_translation_target' => 'Translation target',
			'page_setting_translate.pref_item_title_double_click_copy_result' => 'Double-click to copy translation result',
			...
			'page_settings.pref_section_title_service_integration' => 'Service Integration',
			...
			'page_settings.pref_item_title_keyboard_shortcuts' => 'Keyboard Shortcuts',
			'page_settings.pref_item_title_submit_with_enter' => 'Submit with Enter',
			'page_settings.pref_item_title_submit_with_meta_enter' => 'Submit with Ctrl + Enter',
			'page_settings.pref_item_title_submit_with_meta_enter_mac' => 'Submit with ⌘ + Enter',
			'page_settings.pref_item_title_launch_at_startup' => 'Launch when you log in',
			...
			'page_runtime_debug.description' => 'Validate flutter_rust_bridge by calling the Rust runtime directly from desktop.',
			'page_runtime_debug.mac_only_note' => 'This validation page is planned for macOS first. Other desktop platforms may compile but are not part of this verification scope.',
			'page_runtime_debug.provider_section_title' => 'Provider',
			'page_runtime_debug.provider_config_label' => 'Provider config YAML',
			'page_runtime_debug.request_section_title' => 'Request',
			'page_runtime_debug.source_language_label' => 'Source language (optional)',
			...
			'page_runtime_debug.result_idle_description' => 'Submit a request to inspect the Rust runtime response here.',
			'page_runtime_debug.result_success' => 'Rust runtime response',
			'page_runtime_debug.result_error' => 'Rust runtime error',
			'page_runtime_debug.validation_provider_config_required' => 'Provider config YAML is required',
			'page_runtime_debug.validation_source_language_required' => 'Source language is required',
			'page_runtime_debug.validation_target_language_required' => 'Target language is required',
			...
			'page_translation_engine_chooser.pref_item_title_no_available_engines' => 'No available engines',
			'page_translation_engine_create_or_edit.title' => 'Add Text Translation Engine',
			'page_translation_engine_create_or_edit.pref_section_title_engine_type' => 'Engine type',
			'page_translation_engine_create_or_edit.pref_section_title_support_interface' => 'Support interface',
			'page_translation_engine_create_or_edit.pref_section_title_option' => 'Option',
			...
			'page_translation_engines_manage.pref_section_description_private' => 'Long press an item to reorder it',
			'page_translation_target_new.title' => 'Add Translation Target',
			'page_translation_target_new.title_with_edit' => 'Edit Translation Target',
			...
			'page_your_plan_selector.pref_section_title_plans' => 'Choose the right plan for you.',
			'page_your_plan_selector.pref_section_title_activate_your_plan' => 'Activate Your Pla',
			'page_your_plan_selector.pref_section_title_your_plan_expiry_date' => 'Your plan expiry date',
			'page_your_plan_selector.pref_item_title_get_activation_code' => 'Get activation code',
			'page_your_plan_selector.msg_plan_pro_coming_soon' => 'Coming soon, Please stay tuned.',
